...
void Platform::setup() {
  ...
  // put actuators in desired starting lengths 
  // for now, start actuators at 0 length 
  
  Serial.println("finish platform setup");
}

void Platform::loop() {
  // is platform has reached the end of the movement loop then restart the loop 
  if (isPlatformReady()) {
